...
```
> /b is word boundary, make sure after "t" not have any word.
---
...
chmod +t /opt/appdata
```
> sticky bit is make sure all user can not remove file who is not the owner.
...
#### make file for script /home/bob/filter.sh
```
...
```
> x extract, z gzip, O stdout, f file.
